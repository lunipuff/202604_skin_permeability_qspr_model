...
writeLines(svg_text, "figures/figure_workflow.svg")

rsvg::rsvg_png(
	charToRaw(svg_text),
	file = "figures/figure_workflow.png",
	width = 2400,
	height = 3000
)
...
rsvg::rsvg_pdf(
	charToRaw(svg_text),
	file = "figures/figure_workflow.pdf",
	width = 8,
	height = 10
)

message("Workflow figure written to:")
message("  figures/figure_workflow.svg")
message("  figures/figure_workflow.png")
message("  figures/figure_workflow.pdf")